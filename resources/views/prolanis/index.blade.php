...
<script>
    ...
    function loadTable(queryParam = ''){
        ...
        var table = $('#table-prolanis').DataTable({
            processing: true,
            serverSide: true,
            ajax: 'https://ehealthprc.com/api/api/v1/prolanis?' + queryParam,
            searchDelay: 500,
            columns: [
                {
                    data: 'no_rm',
    ...
    $('#form-cek-lab').submit(function(e){
        ...
        if (tanggal == ''){
            ...
            $.ajax({
                url: "https://ehealthprc.com/api/api/v1/prolanis/create-jadwal-cek-lab",
                method: "POST",
                dataType: "json",
                data: dataForm,
                success: function (response) {
    ...
    $('#form-last-ceklab').submit(function(e){
        ...
        if (tanggal == ''){
            ...
            $.ajax({
                url: "https://ehealthprc.com/api/api/v1/prolanis/update-jadwal-cek-lab",
                method: "POST",
                dataType: "json",
                data: dataForm,
                success: function (response) {
    ...
    $('#form-pasien-edit-prolanis').submit(function(e){
        ...
        if (jenis == ''){
            ...
            $.ajax({
                url: "https://ehealthprc.com/api/api/v1/prolanis/update-status-prolanis",
                method: "POST",
                dataType: "json",
                data: dataForm,
                success: function (response) {
