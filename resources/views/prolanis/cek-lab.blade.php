                        ...
                        if (role == 'admin' || role == 'rm') {
                            if (row.datang == null){
                                ...
                                if (row.datang == 1 && row.hasil == null){
                                    actionBtn += '<a href="/pasien/download/fhlp/'+row.id+'" class="btn btn-success btn-sm btn-input-hasil-prolanis me-2" prolanis="'+row.keterangan_prolanis+'" ceklabid="'+row.id+'">Form</a>';
