                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="no_ktp" id="noKtp" class="form-control"
                                                    placeholder="NIK KTP" value="{{$pasien->nik}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="alamat" id="alamat" class="form-control input-form-alamat"
                                                ...
                                                placeholder="Alamat KTP">{{$pasien->alamat}}</textarea>
...
<script>
    ...
    var provinceSelected = '{{$pasien->provinsi}}';
    var citySelected = '{{$pasien->kota}}';
    var districtSelected = '{{$pasien->kecamatan}}';
    var villageSelected = '{{$pasien->kelurahan}}';
    var caraBayar = '{{$pasien->cara_bayar}}';
