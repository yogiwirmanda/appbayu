...
<div class="container-fluid">
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{route('update_rumahsakit')}}" class="form theme-form" id="form-rumahsakit" method="POST"
                enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id_rumahsakit" value="{{$dataRumahsakit->id}}">
                <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rumahsakit" id="nama_rumahsakit"
                                        ...
                                        value="{{$dataRumahsakit->rumahsakit}}">
