...
<div class="container-fluid">
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{route('update_pekerjaan')}}" class="form theme-form" id="form-pekerjaan" method="POST"
                enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id_pekerjaan" value="{{$dataPekerjaan->id}}">
                <div class="row">
