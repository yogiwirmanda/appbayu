...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form class="form theme-form" method="post" action="{{route('kunjungan_pasien_update')}}"
                        enctype="multipart/form-data" id="formKunjungan">
                        @csrf
                        <input type="hidden" name="type" value="{{$type}}">
                        <input type="hidden" name="id_kunjungan" value="{{$kunjunganId}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-8">
                                                <select class="form-control select2" name="poli" id="poli">
                                                    ...
                                                    <option value="{{$poli->id}}" {{($poli->id ==
                                                        $dataKunjungan->id_poli) ? 'selected' : ''}}>{{$poli->nama}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-8">
                                                <input type="text" class="form-control" disabled
                                                    value="{{$dataKunjungan->bayar}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row row-bpjs {{($dataKunjungan->bayar == 'BPJS') ? '' : 'd-none'}}">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-8">
                                                <input type="text" class="form-control" disabled
                                                    value="{{($dataKunjungan->jenis_pasien == '2') ? 'Lama' : 'Baru'}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-8">
                                                @php
                                                switch ($dataKunjungan->jenis_kunjungan) {
                                                case 1:
                                                $showJenisKunjungan = 'Sakit';
                                                break;
                                                case 2:
                                                $showJenisKunjungan = 'Surat Sehat';
                                                break;
                                                case 3:
                                                $showJenisKunjungan = 'Surat Catin';
                                                break;
