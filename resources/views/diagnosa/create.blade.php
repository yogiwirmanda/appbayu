...
<div class="container-fluid mt--6">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{route('save_diagnosa')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <input type="text" name="kode_icd" id="kode_icd" class="form-control col-6" placeholder="Kode ICD">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <textarea name="diagnosa" id="diagnosa" cols="30" rows="10" class="form-control col-6" placeholder="Diagnosa"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
